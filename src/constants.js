...
import ManualTestingLogo from './assets/tech_logo/ManualTesting.png';
import BugTrackingLogo from './assets/tech_logo/BugTracking.png';
import TestCaseDesignLogo from './assets/tech_logo/TestCaseDesign.png';
import SDLCLogo from './assets/tech_logo/SDLC.png';
import STLCLogo from './assets/tech_logo/STLC.png';
// import csharpLogo from './assets/tech_logo/csharp.png';

// Experience Section Logo's
import spodenentLogo from './assets/company_logo/spodenent_logo.jpg';
import SwasthyaChetnaLogo from  './assets/company_logo/SwasthyaChetna_logo.jpg';
...
import swasthyachetnaLogo from './assets/work_logo/swasthyachetna.jpg';
...
export const SkillsInfo = [
  ...
  title: 'Testing',
  skills: [
    { name: 'ManualTesting', logo: ManualTestingLogo  },
    { name: 'TestCaseDesign', logo: TestCaseDesignLogo },
    { name: 'BugTracking', logo: BugTrackingLogo},
    { name: 'SDLC', logo: SDLCLogo},
    { name: 'STLC', logo: STLCLogo }
  ],
},
  {
    title: 'Tools',
  ...
  export const experiences = [
    ...
    {
      id: 0,
      img: SwasthyaChetnaLogo,
      role: "UI/UX Developer",
      company: "Swasthya Chetna Private Limited",
      date: " 2026 - 3 months",
      desc: "Event Management Booking System - Developed a full-stack Event Management System that allows users to browse, book, and manage events online. Implemented secure authentication, event scheduling, booking management, and admin controls using modern web technologies",
      skills: [
        "HTML5, CSS3, React.js, Tailwind CSS, Flask, Django, MongoDB"
      ],
    },
  ...
  export const projects = [
...

    {
      ...
      description:
        " Event Management Booking System - Developed a full-stack Event Management System that allows users to browse, book, and manage events online. Implemented secure authentication, event scheduling, booking management, and admin controls using modern web technologies.",
      image: swasthyachetnaLogo,
      tags: ["HTML5", "CSS3", "TailwindCSS", "React.js","Flask", "Django", "MongoDB"],
      github: "This project is currently under development. Stay tuned for updates.",
